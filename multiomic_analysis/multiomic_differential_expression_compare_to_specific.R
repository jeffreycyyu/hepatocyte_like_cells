...
# all_markers_rna = Seurat::FindAllMarkers(all_rna, test.use = "bimod")
# write.table(all_markers_rna, "/home/jyu/scratch/hepatocyte_like_cells/multiomic_analysis/differentially_expressed/rna/all_markers_rna.txt", sep = "\t", row.names = T, col.names = T, quote = F)
# print("rna: finished total differential expression analysis")
# #=====
...
#
# print("FINISHED: rna and atac differential expression analysis (total)")
#
#
