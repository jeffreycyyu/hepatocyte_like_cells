...
gene_set_info = gmtPathways("/home/jyu/scratch/hepatocyte_like_cells/msigdb_gene_sets/h.all.v2023.1.Hs.symbols.gmt")
...
proportion_rna_counts_all_tissue_markers_all_cells_high_plot = ggplot(rna_counts_all_markers_all_cells_high_tissue,
  ...
  xlab("Cell Type") +
  ylab("Proportion of Gene Set RNA Expressed") +
  guides(fill=guide_legend(title="Hallmark Gene Set", override.aes = list(size = 0.1)),
         color = "none",
         alpha = "none")
#save plot
ggsave("/home/jyu/scratch/hepatocyte_like_cells/multiomic_analysis/plots/proportion_rna_counts_gene_set_all_cells_hallmark_plot.pdf", plot = proportion_rna_counts_all_tissue_markers_all_cells_high_plot, width = 14, height = 10)
print("FINISHED hallmark genes !!!!!")
