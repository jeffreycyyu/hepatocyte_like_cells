...
data_dir <- '/home/jyu/scratch/hepatocyte_like_cells/multiomic_analysis/beta_cell_dataset/GSM4143265_unedit'
list.files(data_dir) # Should show barcodes.tsv.gz, features.tsv.gz, and matrix.mtx.gz
data <- Read10X(data.dir = data_dir)
all_rna = CreateSeuratObject(counts = data,
...
# matrixdata_to_make = read.csv("/home/jyu/scratch/hepatocyte_like_cells/multiomic_analysis/beta_cell_dataset/raw_counts.csv", row.names = 1)
# coldata_to_make = read.table(file = '/home/jyu/scratch/hepatocyte_like_cells/multiomic_analysis/beta_cell_dataset/cell_metadata_cols.tsv', sep = '\t', header = TRUE, comment.char = "&", fill = T)
#
#
...
all_rna = all_rna[which(rownames(all_rna) %in% ccds$gene), ]
...
save(all_rna, ccds, file = "/home/jyu/scratch/hepatocyte_like_cells/multiomic_analysis/beta_cell_dataset/seurat_formatted_data_intermediate_before_preprocessing_trash_me_beta_cell_dataset.RData")
...
pdf("/home/jyu/scratch/hepatocyte_like_cells/multiomic_analysis/plots/beta_cell_dataset/feature_scatter_plot_rna_ncount_nfeature.pdf")
...
pdf("/home/jyu/scratch/hepatocyte_like_cells/multiomic_analysis/plots/beta_cell_dataset/variable_features_plot_rna.pdf")
...
#rna: pca plot
pdf("/home/jyu/scratch/hepatocyte_like_cells/multiomic_analysis/plots/beta_cell_dataset/pca_plot_rna.pdf")
buffer_space = 5
...
pdf("/home/jyu/scratch/hepatocyte_like_cells/multiomic_analysis/plots/beta_cell_dataset/pc_heatmaps_plot_rna.pdf")
pcs_to_show = 9
...
pdf("/home/jyu/scratch/hepatocyte_like_cells/multiomic_analysis/plots/beta_cell_dataset/umap_plot_rna.pdf")
buffer_space=5
...
save(all_rna, ccds, file = "/home/jyu/scratch/hepatocyte_like_cells/multiomic_analysis/beta_cell_dataset/seurat_formatted_data_beta_cell_dataset.RData")
print("done saving")
